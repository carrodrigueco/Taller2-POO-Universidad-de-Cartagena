...
public class Validadores 
{
    ...
    public static int[] ids_registrados = new int[1000];
    
    
    public static void new_circulo()
    {
        cont_circulos++;
    }
    
    public static boolean validar_id(int id)
    {
        /*
        ...
        */
        ...
        {
            if(id == ids_registrados[i])
            {
                return true;
            }
        }
        
        ids_registrados[actual_id] = id;
        actual_id++;
        return false;
    }
    ...
    public static boolean validar_pentagono(int Lado)
    {
        /*
